...
export default function AmbulanceEmergenciesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">My Emergencies</h2>
        <p className="text-gray-500 mt-1">History of all assigned emergencies</p>
      </div>
